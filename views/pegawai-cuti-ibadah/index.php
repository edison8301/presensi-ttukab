...
/* @var $searchModel app\models\PegawaiCutiIbadahSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Pegawai Cuti Ibadah';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pegawai-cuti-ibadah-index box box-primary">
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'label' => 'Pegawai',
                    'format' => 'raw',
                    'value' => function (PegawaiCutiIbadah $data) {
