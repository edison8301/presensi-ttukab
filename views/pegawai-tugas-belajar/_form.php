...
<div class="pegawai-tugas-belajar-form box box-primary">

    <div class="box-header">
        <h3 class="box-title">Form Pegawai Tugas Belajar</h3>
    </div>
	<div class="box-body">
        ...
        <?= $form->field($model, 'semester')->dropDownList(PegawaiTugasBelajar::getListSemester()) ?>

        <?= $form->field($model, 'indeks_prestasi')->textInput(['maxlength' => true]) ?>
