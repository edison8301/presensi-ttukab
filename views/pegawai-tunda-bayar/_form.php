...
<div class="pegawai-tunda-bayar-form box box-primary">

    <div class="box-header">
        <h3 class="box-title">Form Pegawai Tunda Bayar</h3>
    </div>
	<div class="box-body">
        ...
        <?= $form->field($model, 'id_pegawai_tunda_bayar_jenis')->dropDownList(
            \app\models\PegawaiTundaBayarJenis::getList(),
            [
                'prompt' => '- Pilih Jenis -',
            ]
        )->label('Jenis'); ?>
