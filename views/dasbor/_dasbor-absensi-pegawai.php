...
<div class="box box-primary">
	...
	<div class="box-body">
		...
		<tr>
			...
			<th style="text-align: center">Jumlah Absen</th>
		...
		?>
		<?php $i=1; foreach($dasborAbsensi->getManyPegawai()->all() as $pegawai) { ?>
		<?php
		...
		<tr class="<?php // $class; ?>">
			...
			<td><?= $pegawai->nip; ?></td>
			<td><?= Html::a($pegawai->nama,['/pegawai/absensi','id'=>$pegawai->id]); ?></td>
