...
<table cellpadding="11" border="1" style="margin-bottom: 70px; background: #ffffff">
    ...
    <?php $i=1; foreach($query->all() as $instansiPegawai) { ?>
        ...
        <tr>
            ...
            <td class="7" style="text-align: right"><?= Helper::rp($pegawai->getTpp70($searchModel->bulan)) ?></td>
            ...
            <td class="10" style="text-align: right"><?= Helper::rp($pegawai->getTpp30($searchModel->bulan)); ?></td>
