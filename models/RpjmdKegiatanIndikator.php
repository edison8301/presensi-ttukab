...
/**
 * This is the model class for table "rpjmd_kegiatan_indikator".
 *
 * @property int $id
 * @property int $id_instansi
 * @property int $id_rpjmd
 * @property int $id_rpjmd_kegiatan
 ...
 */
class RpjmdKegiatanIndikator extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'rpjmd_kegiatan_indikator';
    }
    ...
    {
        return [
            [['id_instansi', 'id_rpjmd', 'id_rpjmd_kegiatan', 'status_perubahan', 'id_model_perubahan'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_rpjmd' => 'Id Rpjmd',
            'id_rpjmd_kegiatan' => 'Id Rpjmd Kegiatan',
            'nama' => 'Nama',
            'satuan' => 'Satuan',
