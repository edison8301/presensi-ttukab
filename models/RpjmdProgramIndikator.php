...
/**
 * This is the model class for table "rpjmd_program_indikator".
 *
 * @property int $id
 ...
 */
class RpjmdProgramIndikator extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'rpjmd_program_indikator';
    }
    ...
    {
        return [
            [['id_bidang', 'id_bidang_urusan', 'id_rpjmd', 'id_rpjmd_misi', 'id_rpjmd_tujuan', 'id_rpjmd_sasaran', 'id_rpjmd_program', 'id_instansi', 'status_perubahan', 'id_model_perubahan'], 'integer'],
            ...
            [['nama', 'satuan', 'kondisi_awal', 'kondisi_akhir', 'skpd_penanggung_jawab', 'tingkat_capaian_dana_n1', 'tingkat_capaian_dana_n2', 'tingkat_capaian_dana_n3', 'tingkat_capaian_dana_n4', 'tingkat_capaian_dana_n5', 'tingkat_capaian_dana_n6', 'username_pembuat', 'username_pengubah'], 'string', 'max' => 255],
