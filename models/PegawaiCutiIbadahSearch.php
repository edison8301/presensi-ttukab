...
/**
 * PegawaiCutiIbadahSearch represents the model behind the search form of `app\models\PegawaiCutiIbadah`.
 */
class PegawaiCutiIbadahSearch extends PegawaiCutiIbadah
{
    public $nama_pegawai;
