...
class GrupController extends Controller
{
    ...
    public function actionView($id=null)
    {
        ...
        $grupSearchModel = new GrupPegawaiSearch();
        $grupDataProvider = $grupSearchModel->search(Yii::$app->request->queryParams);

        return $this->render('view', [
            'model' => $this->findModel($id),
            'grupSearchModel' => $grupSearchModel,
            'grupDataProvider' => $grupDataProvider,
        ]);
    }
    ...
    public function exportExcel($params)
    {
        ...
        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data Grup');
