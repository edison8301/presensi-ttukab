...
use app\models\RekapJenisSearch;
...
/**
 * RekapJenisController implements the CRUD actions for RekapJenis model.
 */
class RekapJenisController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all RekapJenis models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new RekapJenisSearch();
    ...
    /**
     * Displays a single RekapJenis model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new RekapJenis model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new RekapJenis();
    ...
    /**
     * Updates an existing RekapJenis model.
    ...
    /**
     * Deletes an existing RekapJenis model.
    ...
    /**
     * Finds the RekapJenis model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RekapJenis the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RekapJenis::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('E3', 'Deleted At');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data RekapJenis');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('E' . $row, $data->deleted_at);
