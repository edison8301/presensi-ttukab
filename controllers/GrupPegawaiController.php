...
use app\models\GrupPegawaiSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * GrupPegawaiController implements the CRUD actions for GrupPegawai model.
 */
class GrupPegawaiController extends Controller
{
    ...
    /**
     * Lists all GrupPegawai models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new GrupPegawaiSearch();
    ...
    /**
     * Displays a single GrupPegawai model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new GrupPegawai model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate($id_grup)
    {
        $model = new GrupPegawai([
            'id_grup' => $id_grup
        ]);
    ...
    /**
     * Updates an existing GrupPegawai model.
    ...
    /**
     * Deletes an existing GrupPegawai model.
    ...
    /**
     * Finds the GrupPegawai model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return GrupPegawai the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = GrupPegawai::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('B3', 'Id Grup');
        $sheet->setCellValue('C3', 'Id Pegawai');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data GrupPegawai');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('B' . $row, $data->id_grup);
