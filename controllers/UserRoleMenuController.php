...
use app\models\UserRoleMenuSearch;
...
/**
 * UserRoleMenuController implements the CRUD actions for UserRoleMenu model.
 */
class UserRoleMenuController extends Controller
{
    ...
    /**
     * Lists all UserRoleMenu models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new UserRoleMenuSearch();
    ...
    /**
     * Displays a single UserRoleMenu model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing UserRoleMenu model.
    ...
    /**
     * Deletes an existing UserRoleMenu model.
    ...
    /**
     * Finds the UserRoleMenu model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return UserRoleMenu the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = UserRoleMenu::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('B3', 'Id User Role');
        $sheet->setCellValue('C3', 'Nama');
        $sheet->setCellValue('D3', 'Path');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data UserRoleMenu');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('B' . $row, $data->id_user_role);
            $sheet->setCellValue('C' . $row, $data->nama);
            $sheet->setCellValue('D' . $row, $data->path);
