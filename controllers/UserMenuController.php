...
class UserMenuController extends Controller
{
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('C3', 'Id User Role Menu');
        $sheet->setCellValue('D3', 'Path');
        $sheet->setCellValue('E3', 'Status Aktif');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data UserMenu');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('C' . $row, $data->id_user_role_menu);
