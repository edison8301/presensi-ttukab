...
use app\models\InstansiBidangSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * InstansiBidangController implements the CRUD actions for InstansiBidang model.
 */
class InstansiBidangController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all InstansiBidang models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new InstansiBidangSearch();
    ...
    /**
     * Displays a single InstansiBidang model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new InstansiBidang model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new InstansiBidang();
    ...
    /**
     * Updates an existing InstansiBidang model.
    ...
    /**
     * Deletes an existing InstansiBidang model.
    ...
    /**
     * Finds the InstansiBidang model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return InstansiBidang the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = InstansiBidang::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data InstansiBidang');
