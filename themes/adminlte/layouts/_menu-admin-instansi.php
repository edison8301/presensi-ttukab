...
if(Yii::$app->params['mode'] === 'tukin') {
    echo Menu::widget([
        ...
        'items' => [
            ...
            ['label' => 'Pegawai', 'icon' => 'list', 'url' => ['/absensi/instansi-pegawai/index-pegawai']],
            ...
            ['label' => 'Rekap IKI', 'icon' => 'book', 'url' => ['/kinerja/instansi-pegawai/rekap-iki']],
            ...
            ['label' => 'Shift Kerja', 'icon' => 'clock-o', 'url' => ['/absensi/pegawai/index-shift-kerja'], 'visible' => Session::isVisibleShiftKerja()],
            ...
            //['label' => 'Upload Presensi Manual', 'icon' => 'file-o', 'url' => ['/remote/upload-presensi-remote/index']],
            ...
            //['label' => 'Laporan dan Rekap', 'icon' => 'users', 'url' => ['/tukin/pegawai/index']],
            ...
            //['label' => 'Serapan Anggaran', 'icon' => 'building', 'url' => ['/tukin/instansi/profil']],
...
if(Yii::$app->params['mode'] === 'absensi') {
    echo Menu::widget([
        ...
        'items' => [
            ['label' => 'ABSENSI', 'options' => ['class' => 'header']],
            ['label' => 'Pegawai', 'icon' => 'users', 'url' => ['/absensi/pegawai/index']],
            ...
            ['label' => 'Shift Kerja', 'icon' => 'clock-o', 'url' => ['/absensi/pegawai/index-shift-kerja'], 'visible' => in_array(User::getIdInstansi(), [42, 43, 44, 1])],
            ['label' => 'MENU AKUN', 'options' => ['class' => 'header']],
            ['label' => 'Profil', 'icon' => 'user', 'url' => ['/instansi/profil']],
            ['label' => 'Profil Jabatan', 'icon' => 'sitemap', 'url' => ['/instansi/profil-jabatan']],
            ['label' => 'Ganti Password', 'icon' => 'key', 'url' => ['/user/change-password']],
