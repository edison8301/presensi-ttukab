...
<div class="checkinout-view box box-primary">
    ...
    <div class="box-footer">
        ...
        <?= Html::a('<i class="fa fa-trash"></i> Delete Duplicate', ['delete-duplicate','userid'=>$model->userid,'checktime'=>$model->checktime,'sn'=>$model->SN], ['class' => 'btn btn-danger btn-flat','onclick'=>'return confirm("Yakin akan delete duplicate");']) ?>
    </div>
