    ...
    'columns' => [
        ...
        [
            ...
            'value' => function (KegiatanBulanan $data) {
                $output = Html::a($data->kegiatanTahunan->nama,['kegiatan-bulanan/view','id'=>$data->id]).'<br>';
        ...
        [
            ...
            'value'=>function(KegiatanBulanan $data) use ($searchModel) {
                ...
                $output .= Html::a('<i class="fa fa-eye"></i>',['kegiatan-bulanan/view','id'=>$data->id,'mode'=>$searchModel->mode],['data-toggle'=>'tooltip','title'=>'Lihat']).' ';
