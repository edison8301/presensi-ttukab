...
<div class="kegiatan-bulan-view box box-primary">
    ...
    <div class="box-footer">
        <?= Html::a('<i class="fa fa-list"></i> Daftar Kegiatan Bulanan', [
            '/kinerja/kegiatan-bulanan/index-v3',
...
<div class="box box-info">
    ...
    <div class="box-header">
        <?php /* if(@$model->kegiatanTahunan->id_pegawai==User::getIdPegawai()) { ?>
            <?= $this->render('/kegiatan-harian/_modal-kinerja-tahunan', [
                'bulan' => $model->bulan,
    ...
    <div class="box-body">
        <table class="table table-hover table-bordered">
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                <?php $i = 1; ?>
                <?php foreach ($model->getAllKegiatanHarianV3() as $kegiatanHarian): ?>
                    <tr>
                        <td class="text-center"><?= $i++; ?></td>
                        <td class="text-center"><?= Helper::getTanggalSingkat($kegiatanHarian->tanggal); ?></td>
                        <td><?= $kegiatanHarian->uraian; ?></td>
                        <td class="text-center"><?= $kegiatanHarian->realisasi; ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <?= Html::a('<i class="fa fa-eye"></i>', ['kegiatan-harian/view-v4', 'id' => $kegiatanHarian->id]); ?>

                            <?php if($kegiatanHarian->accessUpdate()) { ?>
                                <?= Html::a('<i class="fa fa-pencil"></i>', ['kegiatan-harian/update-v4', 'id' => $kegiatanHarian->id]); ?>
                            <?php } ?>
