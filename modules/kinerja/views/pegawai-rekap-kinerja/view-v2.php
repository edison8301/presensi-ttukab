    ...
    <div class="box-body">
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align: center; width: 400px;">SKP</th>
            ...
            <?php foreach ($model->manyKegiatanBulanan as $kegiatanBulanan) { ?>
                <tr>
                    <td style="text-align: center; width: 10px;" rowspan="4"><?= $i++; ?></td>
                    <td rowspan="4"><?= Html::a(@$kegiatanBulanan->kegiatanTahunan->nama, [
                            'kegiatan-tahunan/view-v2',
                            'id' => @$kegiatanBulanan->kegiatanTahunan->id,
                        ]) ?>
                    </td>
                    <td>Kuantitas</td>
                    <td style="text-align: center;">
                        <?= $kegiatanBulanan->getTargetSatuan(); ?>
                    </td>
                    <td style="text-align: center;">
                        <?= $kegiatanBulanan->getTotalRealisasiBulan([
                            'attribute' => 'realisasi_kuantitas',
                        ]); ?>
                    </td>
                    <td style="text-align: center;" rowspan="4">
                        <?= $kegiatanBulanan->getPersen(); ?>%
                    </td>

                    <?php /* <td style="text-align: center"><?= $kegiatanBulanan->target . ' ' . @$kegiatanBulanan->kegiatanTahunan->satuan_kuantitas ?></td>
