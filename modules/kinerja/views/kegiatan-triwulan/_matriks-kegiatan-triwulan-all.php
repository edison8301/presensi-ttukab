    ...
    <table class="table table-hover table-bordered">
        <thead>
            <tr>
                ...
                <th style="vertical-align:middle;text-align: center" colspan="8">Rencana Target / Realisasi Pada Triwulan</th>
            </tr>
            <tr>
                <?php for ($i = 1;$i <= 4;$i++) { ?>
                    <th colspan="2" style="text-align:center; width:30px">Periode <?= $i ?></th>
                <?php } ?>
            </tr>
            <tr>
                <?php for ($i = 1;$i <= 4;$i++) { ?>
        ...
        <?php $no=1; foreach($allKegiatanTahunanUtamaInduk as $kegiatanTahunan) {
        ...
        <?php /* $no=1; foreach($allKegiatanTahunanTambahanInduk as $kegiatanTahunan) {
            echo $this->render('_tr-kegiatan-tahunan-recursive', [
                'kegiatanTahunan' => $kegiatanTahunan,
                'level' => 0,
                'no' => $no++,
            ]);
