...
$this->title = "Detail Instansi Pegawai";
...
<div class="box box-info">
    ...
    <div class="box-header with-border">
        <?= Html::a('<i class="fa fa-print"></i> Ekspor PDF', ['export-pdf-skp','id'=>$pegawai->id], ['class' => 'btn btn-primary btn-flat','target' => '_blank']) ?>
        <?= Html::a('<i class="fa fa-print"></i> Ekspor Excel', ['export-excel-skp','id'=>$pegawai->id], ['class' => 'btn btn-success btn-flat']) ?>
    </div>
    <div class="box-body">
