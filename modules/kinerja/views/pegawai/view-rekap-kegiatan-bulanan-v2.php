    ...
    <div class="box-body">
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th style="text-align: center;">Jumlah Kinerja Bulanan</th>
            ...
            <?php foreach ($pegawai->findOrCreateAllPegawaiRekapKinerja() as $item) { ?>
                <?php $datetimeSession = DateTime::createFromFormat('Y-n-d', Session::getTahun().'-'.$item->bulan.'-01');
                    $lock = true;
                    if($datetimeSession->format('Y-m') >= '2021-07') {
                        $lock = false;
                    } ?>
                <tr>
                    ...
                    <td style="text-align: center;">
                        <?= Html::a($item->coutKegiatanBulanan([
                            ...
                            '/kinerja/kegiatan-bulanan/index-v2',
                    ...
                    <td style="text-align: center;">
                        <?= $lock ? 0 : $item->potongan_total ?>
                    </td>
                    <td style="text-align: center;"><?= Html::a('<i class="fa fa-eye"></i>', ['pegawai-rekap-kinerja/view-v2', 'id' => $item->id], ['title' => 'Detail', 'data-toggle' => 'tooltip']) ?></td>
                </tr>
            <?php } ?>
        </table>
    </div>
