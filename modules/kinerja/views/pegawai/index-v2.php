    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value' => function ($data) {
                    return Html::a($data->nama,['/kinerja/pegawai/view-v2','id'=>$data->id]).'<br>NIP. '.$data->nip;
                },
            ...
            [
                'label'=>'Jumlah<br>Kinerja<br>Tahunan',
                'encodeLabel'=>false,
                'format' => 'raw',
                'value' => function (Pegawai $data) {
                    return $data->countKegiatanTahunan(['id_kegiatan_tahunan_versi' => 2]).' Kegiatan';
                },
                'headerOptions' => ['style' => 'text-align:center;;vertical-align:middle'],
                'contentOptions' => ['style' => 'text-align:center;'],
            ],
