...
$date = $rekapHarianForm->getDate();

$kinerjaBulan = new \app\components\kinerja\KinerjaBulan([
    'tahun' => $date->format('Y'),
    'bulan' => $date->format('n'),
    'pegawai' => $pegawai,
]);
...
<?= $this->render('_filter-view-rekap-kegiatan-harian-v3', [
    ...
    'action' => [ '/kinerja/pegawai/view-rekap-kegiatan-harian-v4', 'id' => $pegawai->id],
]); ?>

<?= $this->render('_box-rekap-ckhp', [
    'kinerjaBulan' => $kinerjaBulan,
]) ?>
