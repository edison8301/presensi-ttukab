...
<div class="kegiatan-harian-view box box-primary">
    ...
    <div class="box-footer">
        ...
        <?= Html::a('<i class="fa fa-pencil"></i> Sunting Kegiatan Harian', ['update-v3', 'id' => $model->id], ['class' => 'btn btn-primary btn-flat','visible'=>1]) ?>
        <?php } ?>
        <?= Html::a('<i class="fa fa-list"></i> Daftar Kegiatan Harian', ['kegiatan-harian/index-v3','mode'=>$model->mode], ['class' => 'btn btn-primary btn-flat']) ?>
