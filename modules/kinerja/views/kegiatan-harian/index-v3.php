...
<div class="box box-primary">
    <div class="box-header">
        <?= Html::beginForm(['/kinerja/kegiatan-harian/index-v3'], 'post'); ?>

        <?php if(KegiatanHarian::accessCreate()) { ?>

            <?php if (Session::isKinerjaPP30Aktif()) { ?>
                        ...
                        <td rowspan="4" style="text-align: center">
                            <?php
                                ...
                                if($data->accessUpdate()) {
                                    $output .= Html::a('<i class="fa fa-pencil"></i>', ['/kinerja/kegiatan-harian/update-v3', 'id' => $data->id], ['data-toggle' => 'tooltip', 'title' => 'Ubah']) . ' ';
                                }
