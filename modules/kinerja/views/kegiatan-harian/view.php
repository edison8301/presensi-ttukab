...
<div class="kegiatan-harian-view box box-primary">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'format' => 'raw',
                'value' => Helper::getTanggalDanJam($model->waktu_dibuat),
            ],
        ],
    ]) ?>
    ...
    <div class="box-footer">
        ...
        <?= Html::a('<i class="fa fa-pencil"></i> Sunting Kegiatan Harian', ['update', 'id' => $model->id], ['class' => 'btn btn-primary btn-flat','visible'=>1]) ?>
        <?php } ?>
        <?= Html::a('<i class="fa fa-list"></i> Daftar Kegiatan Harian', ['kegiatan-harian/index','mode'=>$model->mode], ['class' => 'btn btn-primary btn-flat']) ?>
