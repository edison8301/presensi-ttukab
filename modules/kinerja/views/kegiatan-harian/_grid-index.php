        ...
        [
            ...
            'value'=>function(KegiatanHarian $data) use ($searchModel) {
                ...
                if($data->accessSetKonsep()) {
                    $output .= Html::a('<i class="fa fa-refresh"></i>', ['kegiatan-harian/set-konsep', 'id' => $data->id], ['data-toggle' => 'tooltip', 'title' => 'Ubah Jadi Konsep', 'onclick' => 'return confirm("Yakin akan mengubah kegiatan jadi konsep?");']) . ' ';
                }
