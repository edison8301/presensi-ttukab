...
/* @var \app\modules\kinerja\models\KegiatanHarian $searchModel */
...
echo GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'format' => 'raw',
            'value' => function(KegiatanTahunan $data) {
                $output = Html::a($data->realisasi_kuantitas.' '.$data->satuan_kuantitas,[
        ...
        [
            ...
            'format' => 'raw',
            'value' => function($data) {
                return $data->kegiatanStatus ? $data->kegiatanStatus->getLabel() : '';
            },
