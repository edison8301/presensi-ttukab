...
<div class="kegiatan-tahunan-form box box-primary">
    ...
    <div class="box-header">
        <h3 class="box-title">Form Kegiatan Tahunan</h3>
    </div>
	<div class="box-body">
        ...
        */ ?>
        ...
        ])->textInput(['maxlength' => true])->label('Target Waktu') ?>

        <?= $form->field($model, 'target_angka_kredit',[
            'horizontalCssClasses' => [
                'label' => 'col-sm-2',
                'wrapper' => 'col-sm-2',
                'error' => '',
        ...
        ])->textInput(['maxlength' => true])->label('Target Angka Kredit')->hint('(Khusus JFT)') ?>
        ...
        <?php if ($model->pegawai !== null && $model->pegawai->getIsEselonII()): ?>
            ...
            ])->textInput(['maxlength' => true])->label('Target Biaya') ?>
        <?php endif ?>
