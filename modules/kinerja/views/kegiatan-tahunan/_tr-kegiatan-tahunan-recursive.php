...
<tr>
    ...
    <?php $total_target = 0; for($i=1;$i<=12;$i++) { ?>
        ...
        <td style="text-align:center; padding-top:6px">
            ...
            <?php if($datetimeSession->format('Y-m') >= '2021-07') { ?>
                <?= $kegiatanBulanan->accessUpdate() ?
                    Editable::widget([
        ...
        <td style="text-align:center; padding-top:6px">
            ...
            <?php if($datetimeSession->format('Y-m') >= '2021-07') { ?>
                <?= $kegiatanBulanan->accessUpdate() ?
                    ...
                    $kegiatanBulanan->target_kualitas; ?>
            <?php } else { ?>
                -
            <?php } ?>
