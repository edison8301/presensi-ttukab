...
$this->title = "Ubah Rencana Kinerja Tahunan Atasan";
...
<div class="kegiatan-tahunan-form box box-primary">
    ...
    <div class="box-header">
        <h3 class="box-title">Form Rencana Kinerja Tahunan Atasan</h3>
    </div>
	<div class="box-body">
        ...
        <?= $form->field($model, 'nama')->textArea(['rows' => 5, 'readonly' => 'readonly'])->label('Rencana Kinerja') ?>
        ...
        <div id="id-kegiatan-tahunan-atasan">
            <?php print $form->field($model, 'id_kegiatan_tahunan_atasan')->dropDownList(
                ...
                ['prompt' => 'Pilih Rencana Kinerja Tahunan Atasan']
            )->label('Kinerja Atasan yang Didukung'); ?>
