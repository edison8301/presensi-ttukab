...
use app\modules\kinerja\models\KegiatanHarianDiskresiSearch;
...
/**
 * KegiatanHarianDiskresiController implements the CRUD actions for KegiatanHarianDiskresi model.
 */
class KegiatanHarianDiskresiController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all KegiatanHarianDiskresi models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new KegiatanHarianDiskresiSearch();
    ...
    /**
     * Displays a single KegiatanHarianDiskresi model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new KegiatanHarianDiskresi model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new KegiatanHarianDiskresi();
    ...
    /**
     * Updates an existing KegiatanHarianDiskresi model.
    ...
    /**
     * Deletes an existing KegiatanHarianDiskresi model.
    ...
    /**
     * Finds the KegiatanHarianDiskresi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return KegiatanHarianDiskresi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = KegiatanHarianDiskresi::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data KegiatanHarianDiskresi');
    ...
    public static function accessMenu()
    {
        ...
        if (in_array($id_user, [5877, 5965])) { // DEV & ADMIN_ANTON
            return true;
        }
