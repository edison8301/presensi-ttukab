...
use app\modules\kinerja\models\SkpPerilakuSearch;
...
/**
 * SkpPerilakuController implements the CRUD actions for SkpPerilaku model.
 */
class SkpPerilakuController extends Controller
{
    ...
    /**
     * Lists all SkpPerilaku models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SkpPerilakuSearch();
    ...
    /**
     * Displays a single SkpPerilaku model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SkpPerilaku model.
    ...
    /**
     * Updates an existing SkpPerilaku model.
    ...
    /**
     * Deletes an existing SkpPerilaku model.
    ...
    /**
     * Finds the SkpPerilaku model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SkpPerilaku the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SkpPerilaku::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('C3', 'Id Skp Perilaku Jenis');
        $sheet->setCellValue('D3', 'Ekspektasi');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data SkpPerilaku');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('C' . $row, $data->id_skp_perilaku_jenis);
            $sheet->setCellValue('D' . $row, $data->ekspektasi);
