...
<div class="pegawai-index box box-primary">
    ...
    <div class="box-header">
        <?php //Html::a('<i class="fa fa-refresh"></i> Refresh Rekap Absensi', Yii::$app->request->url.'&refresh=1', ['class' => 'btn btn-primary btn-flat','onclick'=>'return confirm("Yakin akan merefresh rekap absensi? Proses refresh akan memakan waktu beberapa menit")']) ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'nama',
                'format' => 'raw',
                'value' => function ($data) use ($pegawaiSearch) {

                    return Html::a(Html::encode($data->nama),['/absensi/pegawai/view','id'=>$data->id, 'PegawaiSearch' => ['bulan' => $pegawaiSearch->bulan]]).'<br>NIP. '.$data->nip;
                },
