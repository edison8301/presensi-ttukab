            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        return Html::a(Html::encode($data->nama),['/absensi/pegawai/view-template','id'=>$data->id]).'<br>'.$data->nip;
                    },
                ...
                [
                    ...
                    'value'=>function($data) {
                        $output  = '';
                        $output .= Html::a('<i class="fa fa-eye"></i>',['view-template','id'=>$data->id],['data-toggle'=>'tooltip','title'=>'Lihat Userinfo']);
                        return trim($output);
                    },
