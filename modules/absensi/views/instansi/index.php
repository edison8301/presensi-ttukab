...
<div class="instansi-index box box-primary">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'label'=>'Absensi<br>Terakhir',
                'encodeLabel'=>false,
                'format'=>'raw',
                'value'=>function($data) {
                    return $data->getTextChecktimeTerakhir();
                },
            ...
            [
                'label'=>'Aktivitas<br>Mesin<br>Terakhir',
                'encodeLabel'=>false,
                'format'=>'raw',
                'value'=>function($data) {
                    return $data->getTextLastActivityTerakhir();
                },
                'headerOptions'=>['style'=>'text-align:center;vertical-align:middle; width:150px'],
                'contentOptions'=>['style'=>'text-align:center;'],
            ],
            [
                ...
                'value'=>function($data) {
                    $output  = '';
                    $output .= Html::a('<i class="fa fa-calendar"></i>',['/absensi/pegawai/index','PegawaiSearch[id_instansi]'=>$data->id],['data-toggle'=>'tooltip','title'=>'Daftar Rekap Absensi']).' ';
                    $output .= Html::a('<i class="fa fa-clock-o"></i>',['view','id'=>$data->id],['data-toggle'=>'tooltip','title'=>'Daftar Aktivitas Absensi']).' ';
                    return trim($output);
                },
