...
<table class="table table-bordered" cellpadding="3px" style="font-size:11px; margin-bottom: 20px;">
    <thead>
        <tr>
            ...
            <th style="vertical-align: middle; text-align: center; vertical-align: bottom; border-bottom: 0px">JABATAN</th>
...
<?php //$instansiPegawai->pegawai->updatePegawaiRekapAbsensi($searchModel->bulan); ?>
<?php $pegawaiRekapAbsensi = $instansiPegawai->pegawai->findOrCreatePegawaiRekapAbsensi($searchModel->bulan); ?>
<?php $pegawai = Pegawai::findOne($instansiPegawai->id_pegawai); ?>
<tr>
    <td style="text-align:center"><?= $i; ?></td>
    <td>
        <?= @$pegawai->nama; ?><br>
    ...
    <td style="text-align: center"><?= @$pegawai->getNamaPegawaiGolonganBerlaku(['bulan'=>$searchModel->bulan]); ?></td>
    <td style="text-align: left"><?= @$instansiPegawai->nama_jabatan; ?></td>
