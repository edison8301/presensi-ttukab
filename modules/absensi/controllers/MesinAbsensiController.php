...
use app\modules\absensi\models\MesinAbsensiSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * MesinAbsensiController implements the CRUD actions for MesinAbsensi model.
 */
class MesinAbsensiController extends Controller
{
    ...
    /**
     * Lists all MesinAbsensi models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new MesinAbsensiSearch();
    ...
    /**
     * Displays a single MesinAbsensi model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new MesinAbsensi model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate($id_instansi=null,$serialnumber=null)
    {
        $model = new MesinAbsensi();
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if($model->save()) {
                ...
                return $this->redirect(['mesin-absensi/index']);
            }
    ...
    /**
     * Updates an existing MesinAbsensi model.
    ...
    /**
     * Deletes an existing MesinAbsensi model.
    ...
    /**
     * Finds the MesinAbsensi model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return MesinAbsensi the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = MesinAbsensi::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('C3', 'Serialnumber');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data MesinAbsensi');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('C' . $row, $data->serialnumber);
