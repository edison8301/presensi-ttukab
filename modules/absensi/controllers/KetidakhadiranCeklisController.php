...
use app\modules\absensi\models\KetidakhadiranCeklisSearch;
...
/**
 * KetidakhadiranCeklisController implements the CRUD actions for KetidakhadiranCeklis model.
 */
class KetidakhadiranCeklisController extends Controller
{
    /**
     * @inheritdoc
     */
                ...
                'rules' => [
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            return User::isAdmin() || User::isOperatorAbsen();
                        }
                    ],
                ],
            ],
    ...
    /**
     * Lists all KetidakhadiranCeklis models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new KetidakhadiranCeklisSearch();
    ...
    /**
     * Displays a single KetidakhadiranCeklis model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing KetidakhadiranCeklis model.
    ...
    /**
     * Deletes an existing KetidakhadiranCeklis model.
    ...
    /**
     * Finds the KetidakhadiranCeklis model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return KetidakhadiranCeklis the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = KetidakhadiranCeklis::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data KetidakhadiranCeklis');
