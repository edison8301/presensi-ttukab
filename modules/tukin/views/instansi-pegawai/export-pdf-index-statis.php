...
<tr>
    ...
    <td style="text-align: center"><?= @$instansiPegawai->pegawai->golongan; ?></td>
...
<?php
/** @var Jabatan $kepala */
$kepala = $modelExportPdf->instansi->getManyJabatanKepala()->one();
$nama = null;
$nip = null;
if ($kepala) {
    /** @var Pegawai $pegawaiKepala */
    $pegawaiKepala = $kepala->getManyPegawai()->one();
    if ($pegawaiKepala) {
        $nama = $pegawaiKepala->nama;
        $nip = $pegawaiKepala->nip;
    }
}
?>
<table class="table">
