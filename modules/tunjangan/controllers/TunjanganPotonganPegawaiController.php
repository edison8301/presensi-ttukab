...
use app\modules\tunjangan\models\TunjanganPotonganPegawaiSearch;
...
/**
 * TunjanganPotonganPegawaiController implements the CRUD actions for TunjanganPotonganPegawai model.
 */
class TunjanganPotonganPegawaiController extends Controller
{
    ...
    /**
     * Lists all TunjanganPotonganPegawai models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TunjanganPotonganPegawaiSearch();
    ...
    /**
     * Displays a single TunjanganPotonganPegawai model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TunjanganPotonganPegawai model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TunjanganPotonganPegawai();
    ...
    /**
     * Updates an existing TunjanganPotonganPegawai model.
    ...
    /**
     * Deletes an existing TunjanganPotonganPegawai model.
    ...
    /**
     * Finds the TunjanganPotonganPegawai model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TunjanganPotonganPegawai the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TunjanganPotonganPegawai::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $sheet->setCellValue('B3', 'Id Tunjangan Potongan');
        $sheet->setCellValue('C3', 'Id Pegawai');
        $sheet->setCellValue('D3', 'Tanggal Mulai');
        $sheet->setCellValue('E3', 'Tanggal Selesai');

        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data TunjanganPotonganPegawai');
        ...
        foreach($searchModel->getQuerySearch($params)->all() as $data){
            ...
            $sheet->setCellValue('B' . $row, $data->id_tunjangan_potongan);
