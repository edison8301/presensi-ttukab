...
use app\modules\tunjangan\models\JabatanTunjanganKhususPegawaiSearch;
...
/**
 * JabatanTunjanganKhususPegawaiController implements the CRUD actions for JabatanTunjanganKhususPegawai model.
 */
class JabatanTunjanganKhususPegawaiController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all JabatanTunjanganKhususPegawai models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new JabatanTunjanganKhususPegawaiSearch();
    ...
    /**
     * Displays a single JabatanTunjanganKhususPegawai model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new JabatanTunjanganKhususPegawai model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new JabatanTunjanganKhususPegawai();
    ...
    /**
     * Updates an existing JabatanTunjanganKhususPegawai model.
    ...
    /**
     * Deletes an existing JabatanTunjanganKhususPegawai model.
    ...
    /**
     * Finds the JabatanTunjanganKhususPegawai model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return JabatanTunjanganKhususPegawai the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = JabatanTunjanganKhususPegawai::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data JabatanTunjanganKhususPegawai');
