...
use app\modules\tunjangan\models\TunjanganPotonganSearch;
...
/**
 * TunjanganPotonganController implements the CRUD actions for TunjanganPotongan model.
 */
class TunjanganPotonganController extends Controller
{
    ...
    /**
     * Lists all TunjanganPotongan models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TunjanganPotonganSearch();
    ...
    /**
     * Displays a single TunjanganPotongan model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TunjanganPotongan model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TunjanganPotongan();
    ...
    /**
     * Updates an existing TunjanganPotongan model.
    ...
    /**
     * Deletes an existing TunjanganPotongan model.
    ...
    /**
     * Finds the TunjanganPotongan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TunjanganPotongan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TunjanganPotongan::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    public function exportExcel($params)
    {
        ...
        $PHPExcel->getActiveSheet()->setCellValue('A1', 'Data TunjanganPotongan');
