...
<table cellpadding="6" border="1" style="background: #ffffff; margin-bottom:20px">
    ...
    <tr>
        ...
        <th width="55px">GOL.IX</th>
        <th width="55px">GOL.IV</th>
        <th width="55px">GOL.III</th>
        <th width="55px">GOL.X</th>
    ...
    <?php $i=1; foreach($query->all() as $instansiPegawai) { ?>
        ...
        <tr>
            ...
            <td style="text-align: right">
                <?= Helper::rp($pegawai->getJumlahKotorTPP($searchModel->bulan), 0); ?>
            ...
            <td style="text-align: center"><?= number_format($pegawai->getPotonganPajakByGolonganX(['bulan'=>$searchModel->bulan]),2); ?> %</td>
            <td style="text-align: center"><?= number_format($pegawai->getPersenPotonganPajak(['bulan'=>$searchModel->bulan]),2); ?> %</td>
            <td style="text-align: right">
                <?= Helper::rp($pegawai->getRupiahTPPBersih($searchModel->bulan), 0); ?>
