...
<table>
    ...
    <tr>
        <td>BULAN</td>
        <td>:</td>
        <td style="text-transform:uppercase"><?= @$namaBulan ?></td>
    </tr>
</table>
        ...
        <tr>
            ...
            <td style="text-align: right">
                <?php
                    ...
                    $tpp_sebelum_pajak = $pegawai->getRupiahTPPSebelumPajak14($searchModel->bulan, [
                        'tukin' => true,
                        'penundaan' => $penundaan,
                    ]); ?>
            ...
            <td style="text-align: right"><?= Helper::rp($pegawai->getRupiahTunjanganPlt14($searchModel->bulan),0); ?></td>
            <td style="text-align: center"><?= $pegawai->getVolumePerBulan(); ?></td>
            <td style="text-align: right">
                <?= Helper::rp($pegawai->getJumlahKotorTPP14($searchModel->bulan), 0); ?>
                <?php $total_tpp_kotor = $total_tpp_kotor + $pegawai->getJumlahKotorTPP14($searchModel->bulan) ?>
            </td>
            <td style="text-align: center"><?= number_format($pegawai->getPotonganPajakByGolonganIX(['bulan' => $searchModel->bulan]),2); ?> %</td>
            ...
            <td style="text-align: right">
                <?= Helper::rp($pegawai->getRupiahTPPBersih14($searchModel->bulan), 0); ?>
                <?php $total_tpp_bersih = $total_tpp_bersih + $pegawai->getRupiahTPPBersih14($searchModel->bulan) ?>
            </td>
        </tr>
    <?php } ?>
    <tr>
