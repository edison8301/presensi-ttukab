...
/* @var $filter app\modules\tunjangan\models\FilterTunjanganForm */
    ...
    <div class="box-body">
    	<div style="overflow-y: auto">
            <table class="table table-bordered table-hover">
                <tr>
                    <th colspan="2" style="width: 200px">Besaran TPP Dasar Sesuai Pergub (1)</th>
                    <td>
                        <?php if(@$isTampilNilaiTpp == true) { ?>
                            Rp <?= Helper::rp($model->getTppAwalDasar([
                                'bulan' => $filter->bulan,
                            ]), 0) ?>
                        <?php } else { ?>
                ...
                <tr>
                    <th colspan="2" style="width: 200px">Keterangan TPP Dasar (2)</th>
                    <td>
                        <?= $model->getKeteranganLengkapTpp() ?>
                    </td>
                </tr>
                <tr>
                    <th rowspan="4" style="width: 200px;">Tambahan TPP (3)</th>
                    <th style="width: 300px;">
                        Penghargaan
                    </th>
                    <td>
                        Rp <?= Helper::rp($model->getRupiahTppTambahanPenghargaan([
                            'bulan' => $filter->bulan,
                        ]), 0) ?>
                    </td>
                </tr>
                <tr>
                    <th>
                        Pemutakhiran Simadig
                    </th>
                    <td>
                        Rp <?= Helper::rp($model->getRupiahTppTambahanPemutakhiranSimadig([
                            'bulan' => $filter->bulan,
                        ]), 0) ?>
                    </td>
                </tr>
                <tr>
                    <th>
                        Pengisian Renbangkom
                    </th>
                    <td>Rp <?= Helper::rp($model->getRupiahTppTambahanPengisianRenbangkom([
                            'bulan' => $filter->bulan,
                        ]), 0) ?>
                    </td>
                </tr>
                <tr>
                    <th>
                        Pemenuhan Bangkom 20 JP
                    </th>
                    <td>Rp <?= Helper::rp($model->getRupiahTppTambahanPemenuhanBangkom20Jp(), 0) ?></td>
                </tr>
                <tr>
                    <th colspan="2" style="width: 200px">
                        Besaran TPP Sesuai Pergub (4 = 1 + 3)
                    </th>
                    <td>
                        <?php if(@$isTampilNilaiTpp == true) { ?>
                            Rp <?= Helper::rp($model->getTppAwal($filter->bulan, ['v3'=>true]), 0) ?>
                        <?php } else { ?>
                            Dalam Proses Penyesuaian
                        <?php } ?>
                    </td>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td><?= Helper::rp($model->getPersenPotonganSkpBulanan($filter->bulan, null, ['v3' => true]),0,2); ?> %</td>
                </tr>
                <tr>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    <th style="vertical-align: middle" rowspan="13">Rincian Faktor Lainnya</th>
                ...
                <!-- TIDAK MEMENUHI KETERCAPAIAN INDEKS PROFESIONALITAS ASN -->
                <tr>
                    <th style="vertical-align: middle" rowspan="2">TIDAK MEMENUHI IP ASN</th>
                    <th style="vertical-align: middle">Jumlah POT. (%)</th>
                    <td>
                        <?= $model->getPersenPotonganIndexProfAsn($filter->bulan); ?> %
                    </td>
                </tr>
                <tr>
                    <th style="vertical-align: middle">Jumlah POT. (Rp)</th>
                    <td>
                        Rp <?= Helper::rp($model->getRupiahPotonganIndeksProfAsn($filter->bulan),0); ?>
                    </td>
                </tr>
