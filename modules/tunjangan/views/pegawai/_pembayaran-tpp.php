    ...
    <div class="box-body">
    	<div style="overflow-y: auto;">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    <th style="vertical-align: middle" rowspan="5">PPh. PASAL 21</th>
                ...
                <tr>
                    ...
                    <td><?= Helper::rp($model->getPotonganPajakByGolonganIV(['bulan'=>$filter->bulan]),0,2); ?> %</td>
                </tr>
                <tr>
                    <th style="vertical-align: middle">GOL. III</th>
                    <td><?= Helper::rp($model->getPotonganPajakByGolonganIII(['bulan'=>$filter->bulan]),0,2); ?> %</td>
                </tr>
                <tr>
